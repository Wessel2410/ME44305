...
def Sim():
    ...
    def results_printer():
        ...
        print(f"Total amount of hours held in port due to absence of batteries: "
              f"{zero_holdings}")
        return tot_bat, total_warnings, total_charged_bat, total_containers
    
    # Print results
    tot_bat, tot_warn, tot_charge, tot_con = results_printer()
    return zero_holdings, tot_bat, tot_warn, tot_charge, tot_con
